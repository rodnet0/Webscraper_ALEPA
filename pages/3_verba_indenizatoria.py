...
df = conexao.query('SELECT nome_deputado, valor_verba, mes_referencia, classificacao_verba, descricao_verba FROM verba_indenizatoria;', ttl="10m")
...
st.write("### Verba Indenizatória Entre os Anos de 2022 a 2024")
...
fig_deputados = px.bar(
    ...
    # text_auto=".5s",
    orientation="h",
    title="Valor de verba indenizatória por deputado"
)
